...
export async function POST(req: NextRequest) {
  try {
    ...
    if (ch === "SMS") {
      ...
      const html = `<div style="font-family: sans-serif; padding: 20px;"><h2 style="color:#14421a;">ENMAR Email Gateway Online</h2><p>This is a test notification verifying your email configuration.</p></div>`;
