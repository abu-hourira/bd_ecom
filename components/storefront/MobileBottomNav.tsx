...
export default function MobileBottomNav() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 inset-x-0 z-40 bg-white/95 backdrop-blur-xl border-t border-stone-200/90 shadow-[0_-8px_30px_rgba(0,0,0,0.08)] px-2 pt-1.5 pb-2.5">
      <div className="flex items-center justify-around max-w-md mx-auto relative">
        ...
        <button
          ...
          className="relative flex flex-col items-center justify-center -mt-4 py-0.5 px-3 rounded-2xl text-stone-700 cursor-pointer active:scale-90 transition-transform"
        >
          <span className="relative block p-3 rounded-full bg-gradient-to-tr from-[#092C15] via-[#0F4A24] to-[#1B6334] text-amber-400 shadow-lg shadow-forest/30 ring-4 ring-white">
